      ...
      <div className="relative z-10 flex items-center justify-between h-full">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <span className={`text-[10px] font-mono uppercase tracking-widest mt-0.5 ml-7 ${isActive ? 'text-gray-400' : 'text-gray-500 group-hover:text-gray-400'}`}>{item.description}</span>
          </div>
        </div>
